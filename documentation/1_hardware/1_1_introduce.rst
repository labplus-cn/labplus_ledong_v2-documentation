...
乐动掌控2.0 是一款教学用开源硬件，具有丰富的应用场景，满足AIOT物联网教学需求。

板载ESP32-S3双核芯片，支持WiFi和蓝牙双模通信。 

板上集成1.47寸高清lcd彩屏、6轴（加速度+陀螺仪）、磁传感器、声音、数字光线传感器、2个物理按键、6个触摸按键、音频编解码芯片+喇叭。除此外，还有一个阻性输入接口，方便接入各种阻性传感器。丰富多样的传感器和小体积的尺寸、结合蓝牙和WiFi双无线通讯，可现实不同的物联网应用场景。
