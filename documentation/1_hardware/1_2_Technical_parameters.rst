...
.. csv-table:: 硬件参数
    ...
    "2", "屏幕", "高清LCD彩屏, 型号：st7789"
    "3", "实体按键", "(A/B/电源开关机键)"
    "4", "触摸按键", "(P/Y/T/H/O/N)，电容式触摸按键"
    "5", "PSRAM", "8MB"
    "6", "存储", "16MB(Flash)"
    "7", "数字光线传感器", "型号：LTR-308ALS-01"
    ...
    "12", "六轴传感器", "型号：QMI8658C,陀螺仪：量程可选,最高可测±2048°/s 三轴加速度计：量程可选,可测±16G"
    "13", "音频", "型号：es8388解码芯片,功放芯片：NS4150"
    "14", "30万像素摄像头", "型号：GC0328"
    "15", "接口", "6个HY2.0 4PIN拓展接口,8个通道数字I/O,2路I2C"
    "16", "电机接口", "两路PH2.0 2PIN电机驱动输出"
    "17", "电池", "1200mAh锂电池"
  
1.2.2. 供电
--------------------------------

  * 供电方式：USB 5V供电或内置电池供电
  * 工作电压：3.3V
  * 最大工作电流: 500mA
  * 最大负载电流: 1500mA
